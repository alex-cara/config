...
#include "/home/Talos/.cache/wal/colors-wal-dwm.h"
...
const char *spcmd1[] = {"st", "spterm", "-g", "120x34", NULL };
const char *spcmd2[] = {"kitty", "ranger", NULL };
const char *spcmd3[] = {"firefox", NULL };
...
/* media keys */
static const char *pause_play[] = { "playerctl", "play-pause"};
static const char *next_track[] = { "playerctl", "next"};
static const char *prev_track[] = { "playerctl", "previous"};
...
static const Key keys[] = {
  ...
  { 0, XF86XK_AudioPlay, spawn, {.v = pause_play}},
  { 0, XF86XK_AudioPause, spawn, {.v = pause_play}},
